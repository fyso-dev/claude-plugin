...
model: sonnet
allowed-tools: mcp__fyso__select_tenant, mcp__fyso__list_entities, mcp__fyso__get_entity_schema, mcp__fyso__generate_entity, mcp__fyso__publish_entity, mcp__fyso__list_entity_changes, mcp__fyso__create_business_rule, mcp__fyso__generate_business_rule, mcp__fyso__list_business_rules, mcp__fyso__get_business_rule, mcp__fyso__test_business_rule, mcp__fyso__publish_business_rule, mcp__fyso__delete_business_rule, mcp__fyso__create_record, mcp__fyso__query_records, mcp__fyso__update_record, mcp__fyso__delete_record, mcp__fyso__export_metadata, mcp__fyso__import_metadata, mcp__fyso__publish_channel, mcp__fyso__define_channel_tool, mcp__fyso__set_channel_permissions, mcp__fyso__execute_channel_tool, mcp__fyso__search_channels, mcp__fyso__get_channel_tools, mcp__fyso__manage_custom_fields, Read, Write, Bash
---
