...
model: sonnet
allowed-tools: mcp__fyso__select_tenant, mcp__fyso__list_entities, mcp__fyso__get_entity_schema, mcp__fyso__list_business_rules, mcp__fyso__get_business_rule, mcp__fyso__export_metadata, Read, Write, Glob, Grep
---
