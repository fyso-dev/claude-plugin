...
model: sonnet
allowed-tools: mcp__fyso__select_tenant, mcp__fyso__list_entities, mcp__fyso__get_entity_schema, mcp__fyso__list_business_rules, mcp__fyso__query_records, Read, Write, Glob, Grep, Bash
---
