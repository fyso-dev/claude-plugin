...
The tenant starts empty. Suggest using the add-entity workflow to create the first entity.
...
Next steps:
  - the add-entity workflow to add more entities
  - the deploy workflow to publish your app
```
