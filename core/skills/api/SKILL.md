...
- Ver schema de entidades (usa the entity workflow schema`)
- Crear/modificar datos desde the host agent (usa MCP tools)
...
```
the API workflow spec
```

### Ejemplos para una Entidad

```
the API workflow ejemplos products
```

### Generar Cliente TypeScript

```
the API workflow cliente typescript products
```

### Generar Cliente Python

```
the API workflow cliente python customers
```
