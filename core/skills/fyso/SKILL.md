...
3. Invoca the rules workflow para crear la regla
4. Prueba automáticamente con the test workflow
...
Tú: [Invoca the project initialization workflow cafeteria-central]
```

## Comandos Disponibles

- the project initialization workflow <nombre>` - Inicializar proyecto
- the entity workflow <acción>` - Gestionar entidades
- the rules workflow <descripción>` - Crear reglas de negocio
- the test workflow - Ejecutar tests
- the deploy workflow <target>` - Desplegar
- the MCP setup workflow - Configurar MCP
