...
```
the rules workflow facturas Calcular subtotal, aplicar IVA 21%, calcular total
```
...
```
the rules workflow pedidos Descuento: >2000=15%, >1000=10%, >500=5%
```
...
```
the rules workflow productos Si stock < 10, marcar como bajo_stock
```
