...
```
the fields workflow listar productos
the fields workflow listar clientes custom
the fields workflow listar facturas all
```

### Agregar Campo

```
the fields workflow agregar campo notas_internas a productos
the fields workflow agregar campo descuento_especial (decimal, requerido) a facturas
```

### Modificar Campo

```
the fields workflow modificar campo notas_internas en productos como requerido
```

### Eliminar Campo

```
the fields workflow eliminar campo notas_internas de productos
```
