...
- the UI workflow — build a frontend so your team can use it
- the expose workflow — create API channels to connect external tools
- the rules workflow — add more business logic (validations, transforms, automations)
- the add-entity workflow — add more entities as your needs grow
